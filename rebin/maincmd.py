...
def main(args=None):
    ...
    binning.add_argument('-b', '--bin-ratio', action='store', dest='bin_ratio', nargs="*", default=[2, 3, 5], help='write help!')
